...
const double GlobalConfiguration::EXPLICIT_BASIS_BOUND_TIGHTENING_PERCENTAGE_THRESHOLD = 1.0;
...
const double GlobalConfiguration::LEMMA_CERTIFICATION_TOLERANCE = 0.000000001;
