...
public:
    ...
    */
    void encodeQuery( LPSolver &gurobi, const Query &inputQuery, bool relax = false );
    ...
    */
    void encodeCostFunction( LPSolver &gurobi, const LinearExpression &cost );
...
private:
    ...
    */
    ...
    /*
      ...
      preprocessing
    */
    void encodeReLUConstraint( LPSolver &gurobi, ReluConstraint *relu, bool relax );

    /*
      Encode a LeakyReLU constraint f = LeakyReLU(b) into Gurobi as a Piecewise Linear Constraint
    */
    void encodeLeakyReLUConstraint( LPSolver &gurobi, LeakyReluConstraint *lRelu, bool relax );
    ...
    /*
      ...
      a_i \in {0, 1} (i = 1 ~ m)
    */
    void encodeMaxConstraint( LPSolver &gurobi, MaxConstraint *max, bool relax );

    /*
      Encode an abs constraint f = Abs(b) into Gurobi
    */
    void
    encodeAbsoluteValueConstraint( LPSolver &gurobi, AbsoluteValueConstraint *abs, bool relax );

    /*
      Encode a sign constraint f = Sign(b) into Gurobi
    */
    void encodeSignConstraint( LPSolver &gurobi, SignConstraint *sign, bool relax );

    /*
      Encode a disjunction constraint into Gurobi
    */
    void encodeDisjunctionConstraint( LPSolver &gurobi, DisjunctionConstraint *disj, bool relax );

    /*
      Encode a Sigmoid constraint
    */
    void encodeSigmoidConstraint( LPSolver &gurobi, SigmoidConstraint *sigmoid );

    /*
      Encode a Softmax constraint
    */
    void encodeSoftmaxConstraint( LPSolver &gurobi, SoftmaxConstraint *softmax );

    /*
      Encode a Bilinear constraint
    */
    void encodeBilinearConstraint( LPSolver &gurobi, BilinearConstraint *bilinear, bool relax );

    /*
      Encode a Round constraint
    */
    void encodeRoundConstraint( LPSolver &gurobi, RoundConstraint *round, bool relax );
};
