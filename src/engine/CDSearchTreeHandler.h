 ...
 **
 ** The CDSearchTreeHandler class implements a context-dependent SearchTreeHandler class.
...
public:
    ...
    */
    ...
    /*
      Inform SearchTreeHandler of an implied (formerly valid) case split that was discovered.
    */
    ...
    */
    ...
    /*
      Return a list of all splits performed so far, both Search Tree-originating and
